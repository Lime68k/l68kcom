import noise from "../assets/bidules/noisee/noise.export.json";

async function setup() {
  const patchExportURL = "noiseeeeeee.export.json";
  ...
  document.getElementById("patcher-title").innerText =
    patcher.desc.meta.name || "Unnamed Patcher";
...
function attachOutports(device) {
  ...
  device.messageEvent.subscribe((ev) => {
    ...
    document.getElementById("rnbo-console-readout").innerText =
      `${ev.tag}: ${ev.payload}`;
  });
}
